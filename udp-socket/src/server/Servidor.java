...
public class Servidor {
	public static void main(String[] args) {
		try {
			final DatagramSocket ds = new DatagramSocket(5055);
			// ds.setSoTimeout(timeout) //levanta el bloqueo
